      ...
      <section class="intro">
        <section class="hero">
          ...
          <div class="hero-meta">
            ...
            <a class="meta-chip" href="https://github.com/team9ai/free-open-router" target="_blank" rel="noreferrer">
              <svg class="meta-chip-icon" viewBox="0 0 16 16" aria-hidden="true">
              ...
              GitHub Repo <code>team9ai/free-open-router</code>
            </a>
          </div>
        </section>
